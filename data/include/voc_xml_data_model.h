...
namespace daw::json
{
...

    {
        ...
        using type = json_member_list<
            json_number<depth, float>, json_number<height, float>, json_number<width, float>>;
    ...
    template <>
    struct json_data_contract<BndBox>
    {
        ...
        using type = json_member_list<
           ...
           >;
        static inline auto to_json_data(BndBox const &value)
        {
            return std::forward_as_tuple(
                value.xmax,
                value.xmin,
    ...
    struct json_data_contract<Object>
    {
        ...
        static constexpr char const bndbox[] = "bndbox";
    ...
    struct json_data_contract<Annotation>
    {
        ...
        using type = json_member_list<
            json_string<filename>, json_string<folder>, json_string<occluded>, json_string<pose>, json_number<diffcult, int>, json_class<object, Object>, json_class<size, ImgSize>, json_number<segmented, int>>;
